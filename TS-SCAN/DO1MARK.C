...
static char skunktable[FORMS] [48] = {
   /* 16416 */        "0100000100000000000000xxxxxxxxxxxxxxxxxxxxxxxxx",
   /* 19641 */        "0000000000010100100010xxxxxxxxxxxxxxxxxxxxxxxxx",
   /* KSU 1 */        "10100101100000011110000xxxxxxxxxxxxxxxxxxxxxxxxx",
   /* KSU 2 */        "0100101100000101110000xxxxxxxxxxxxxxxxxxxxxxxxx"
            };
...

{
   ...
   for (form=0; form<FORMS; form++)
      if (strncmp(skunkstr, skunktable[form],21)==0) break;
